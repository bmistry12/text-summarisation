...
# define new inputs - in future this would read from cl or csv
...
# store in dataframe for ease when dealing with different amounts of inputted data
...
original = seq2text(seq)
print("---")
print("Summary: " + summary)
print("ROUGE score: ")
print(getRouge(summary, original))
